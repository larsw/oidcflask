...
## Development environment and release process
 ...
 - create virtualenv with Flask and oidcflask installed into it (latter is installed in
...
install it (`pip install oidcflask.tar.gz`), ensure that configuration file exists and
`OIDCFLASK_SETTINGS` environment variable points to it, ensure that user has access to the
